...
export function Illustration({ variant = 'hero', className = '' }: IllustrationProps) {
  if (variant === 'orb') {
    return (
      <div className={['relative overflow-hidden rounded-[var(--radius-xl)] bg-card border border-line max-w-full', className].join(' ')}>
  ...
  if (variant === 'plate') {
    return (
      <div className={['relative flex items-center justify-center overflow-hidden rounded-[var(--radius-lg)] bg-surface-2 border border-line max-w-full', className].join(' ')}>
  ...
  return (
    <div className={['relative overflow-hidden rounded-[var(--radius-xl)] border border-line bg-card max-w-full', className].join(' ')}>
